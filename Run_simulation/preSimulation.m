...
eeT001 = zeros(2, 2, iteration);
eeT01 = zeros(2, 2, iteration);
eeT1 = zeros(2, 2, iteration);
eeT10 = zeros(2, 2, iteration);
eeT100 = zeros(2, 2, iteration);

wwT001 = zeros(2, 2, iteration);
wwT01 = zeros(2, 2, iteration);
wwT1 = zeros(2, 2, iteration);
wwT10 = zeros(2, 2, iteration);
wwT100 = zeros(2, 2, iteration);
...
for iter = 1:iteration
    for num = 1:num_sample
        ...
        R.var001(:,:,iter,num) = ...
            [4*n_variance(1,1)*(meas_dn_001(1,1)^2+meas_dn_001(2,1)^2) 4*n_variance(1,1)*(meas_dn_001(1,1)^2) 4*n_variance(1,1)*(meas_dn_001(1,1)^2) -4*n_variance(1,1)*(meas_dn_001(2,1)^2) -4*n_variance(1,1)*(meas_dn_001(2,1)^2) 0;...
        ...
        R.var01(:,:,iter,num) = ...
            [4*n_variance(2,1)*(meas_dn_01(1,1)^2+meas_dn_01(2,1)^2) 4*n_variance(2,1)*(meas_dn_01(1,1)^2) 4*n_variance(2,1)*(meas_dn_01(1,1)^2) -4*n_variance(2,1)*(meas_dn_01(2,1)^2) -4*n_variance(2,1)*(meas_dn_01(2,1)^2) 0;...
        ...
        R.var1(:,:,iter,num) = ...
            [4*n_variance(3,1)*(meas_dn_1(1,1)^2+meas_dn_1(2,1)^2) 4*n_variance(3,1)*(meas_dn_1(1,1)^2) 4*n_variance(3,1)*(meas_dn_1(1,1)^2) -4*n_variance(3,1)*(meas_dn_1(2,1)^2) -4*n_variance(3,1)*(meas_dn_1(2,1)^2) 0;...
        ...
        R.var10(:,:,iter,num) = ...
            [4*n_variance(4,1)*(meas_dn_10(1,1)^2+meas_dn_10(2,1)^2) 4*n_variance(4,1)*(meas_dn_10(1,1)^2) 4*n_variance(4,1)*(meas_dn_10(1,1)^2) -4*n_variance(4,1)*(meas_dn_10(2,1)^2) -4*n_variance(4,1)*(meas_dn_10(2,1)^2) 0;...
        ...
        R.var100(:,:,iter,num) = ...
            [4*n_variance(5,1)*(meas_dn_100(1,1)^2+meas_dn_100(2,1)^2) 4*n_variance(5,1)*(meas_dn_100(1,1)^2) 4*n_variance(5,1)*(meas_dn_100(1,1)^2) -4*n_variance(5,1)*(meas_dn_100(2,1)^2) -4*n_variance(5,1)*(meas_dn_100(2,1)^2) 0;...
...
meanSysnoise = struct(...
    'var001',mean(vec_processNoise.var001,2),...
