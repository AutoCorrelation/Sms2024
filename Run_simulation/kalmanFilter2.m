function [estimate_state,estimate_covariance,kalman_gain,innovation] = kalmanFilter2(prev_estimate_state,prev_estimate_cov,prev_velocity,Q,R,measurement,meanSysnoise)
    ...
    estimate_state = predict_state + kalman_gain * (innovation);
